...
var English = Messages{
	...
	ChatStatusCycleHint:                    "Shift+Tab ask/auto/plan/splitreason · Ctrl+Y YOLO",
	ChatStatusCycleHintCompact:             "Shift+Tab ask/auto/plan/splitreason · Ctrl+Y YOLO",
	ChatStatusSplitReasonHint:              "SplitReason: master plans, slave executes",
	...
	ApprovalToolLabelCommandTask:           "Scheduled OS command",
	...
	WriteAccessHomeWarning:                 "This grant includes directories under your user home. Be cautious — changes here can affect your entire system.",
	WriteAccessMergedPermissionHint:        "Some directories may still require ordinary permission approval in addition to this grant.",
	WriteAccessProjectHint:                 "This access will be saved to the project's reasonix.toml for future sessions.",
	CommandTaskSubjectPrefix:               "schedule OS command: ",
	CommandTaskReason:                      "This registers a scheduled OS command that will run later, unattended, on every fire. It is not sandboxed and runs with your session's environment, so it needs your explicit approval.",
	CommandTaskDeclined:                    "the user declined this scheduled OS command - do not retry it; ask how they would like to proceed.",
