...
var ChineseTraditional = Messages{
	...
	ChatStatusCycleHint:                    "Shift+Tab 循環詢問/自動/計畫/分推理 · Ctrl+Y YOLO",
	ChatStatusCycleHintCompact:             "Shift+Tab 詢問/自動/計畫/分推理 · Ctrl+Y YOLO",
	ChatStatusSplitReasonHint:              "分推理：主模型規劃，從模型執行",
	...
	ApprovalToolLabelCommandTask:           "排程主機指令",
	...
	WriteAccessApprovalChoices:             "1. 允許一次\n2. 本工作階段允許\n3. 保存到專案設定\n4. 拒絕\n選擇 [1/2/3/4]（相容 y/a/p/n）",
	WriteAccessHomeWarning:                 "此授權包含使用者主目錄下的目錄。請謹慎操作——此處的更改可能影響整個系統。",
	WriteAccessMergedPermissionHint:        "部分目錄可能仍需一般權限核准，此外此授權將生效。",
	WriteAccessProjectHint:                 "此存取權限將儲存到專案的 reasonix.toml，供後續工作階段使用。",
	CommandTaskSubjectPrefix:               "排程執行主機指令：",
	CommandTaskReason:                      "這將註冊一個排程執行的主機指令，之後會在每次觸發時無人值守地執行。它不受沙箱保護，並使用目前工作階段的環境，因此需要你明確核准。",
	CommandTaskDeclined:                    "使用者拒絕了該排程主機指令——請勿重試；請詢問使用者希望如何處理。",
