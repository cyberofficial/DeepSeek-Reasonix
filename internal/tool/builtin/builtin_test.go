...
func TestBuiltinsRegistered(t *testing.T) {
	want := []string{"bash", "code_index", "compress", "cron_create", "cron_delete", "cron_list", "edit_file", "glob", "grep", "ls", "move_file", "multi_edit", "read_file", "schedule_wakeup", "web_fetch", "write_file"}
